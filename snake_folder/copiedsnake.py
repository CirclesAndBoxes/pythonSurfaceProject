# Copied from site: https://pythonprogramming.net/custom-environment-reinforcement-learning-stable-baselines-3-tutorial/
import gymnasium
...
class SnekEnv(gymnasium.Env):
	...
	def step(self, action):
		...
		# Reason we need the "False": all of a sudden it requires 5 things to be returned.
		return observation, self.reward, self.done, False, info

	def reset(self, seed=None, options=None):
		# Some magical required line
